/*! For license information please see main.e9593cab.js.LICENSE.txt */
!(function () {
  var e = {
      472: function (e) {
  ...
  !(function () {
    ...
    var p = n(184),
      ...
      m = function (t) {
        var n = t.blog,
          r = t.handleLikeChange,
          a = t.loggedUser,
          o = t.handleBlogDelete,
          l = n.title,
          i = n.author,
          u = n.likes,
          s = n.url,
        ...
        return (0, p.jsxs)('div', {
          ...
          children: [
            ...
            (0, p.jsxs)('div', {
              style: g,
              children: [
                (0, p.jsx)('a', { href: s, children: s }),
                (0, p.jsxs)('p', {
                  children: [
                    'likes: ',
                    (0, p.jsxs)('span', { children: [u, ' '] }),
                    (0, p.jsx)('button', {
                      name: 'like',
                      onClick: function () {
                        return r(n)
    ...
    var I,
      B =
        ((I = 'undefined' !== typeof Uint8Array && b(Uint8Array)),
        function (e) {
            ...
            return (
              ...
              o.forEach(function (e, r) {
                !Q.isUndefined(e) &&
                  null !== e &&
                  t.append(
                    !0 === i ? re([n], r, l) : null === i ? n : n + '[]',
                    s(e),
                  )
              }),
              !1
            )
        return !!te(e) || (t.append(re(r, n, l), s(e)), !1)
      }
      var f = [],
        d = Object.assign(ae, {
          defaultVisitor: c,
    ...
    var de = (function () {
      ...
      he = 'undefined' !== typeof URLSearchParams ? URLSearchParams : se,
      me = FormData,
      ve = (function () {
        var e
        return (
      ...
      ye = {
        isBrowser: !0,
        classes: { URLSearchParams: he, FormData: me, Blob: Blob },
    ...
    var be = function (e) {
        function t(e, n, r, a) {
          ...
          return (
            ...
            i
              ? (Q.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !l)
    ...
    function _e(e) {
      return !1 === e || null == e ? e : Q.isArray(e) ? e.map(_e) : String(e)
    }
    function Ne(e, t, n, r) {
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                function a(e) {
                  if ((e = Ce(e))) {
                    var a = Q.findKey(n, e)
                    !a || (t && !Ne(0, n[a], a, t)) || (delete n[a], (r = !0))
                  }
                }
              ...
              value: function (e) {
                ...
                return (
                  Q.forEach(this, function (r, a) {
                    var o = Q.findKey(n, a)
                    if (o) return (t[o] = _e(r)), void delete t[a]
                    var l = e
                      ? (function (e) {
                          return e
                            .trim()
    ...
    var De = ye.isStandardBrowserEnv
      ? (function () {
          var e,
        ...
        function (e) {
          return new Promise(function (t, n) {
            ...
            if (
              ...
              var p =
                (e.withCredentials || De(f)) &&
                e.xsrfCookieName &&
                je.read(e.xsrfCookieName)
            ...
            void 0 === a && o.setContentType(null),
              ...
              'function' === typeof e.onDownloadProgress &&
                u.addEventListener('progress', Ue(e.onDownloadProgress, !0)),
              'function' === typeof e.onUploadProgress &&
                u.upload &&
                u.upload.addEventListener('progress', Ue(e.onUploadProgress)),
              (e.cancelToken || e.signal) &&
                ((r = function (t) {
                  u &&
                    (n(!t || t.type ? new ze(null, e, u) : t),
                    u.abort(),
                    (u = null))
                }),
    ...
    var Ie = function (e) {
      for (
        ...
        a < r && ((t = e[a]), !(n = Q.isString(t) ? Me[t.toLowerCase()] : t));
        a++
      );
      if (!n) {
        if (!1 === n)
    ...
    function We(e, t) {
      ...
      var u = {
        ...
        headers: function (e, t) {
          return a(He(e), He(t), !0)
        },
      }
      return (
        Q.forEach(Object.keys(e).concat(Object.keys(t)), function (r) {
          var o = u[r] || a,
            l = o(e[r], t[r], r)
          ...
          J(e, [
            {
              ...
              value: function (e, t) {
                ...
                void 0 !== a &&
                  ...
                  (n = l && Q.merge(l.common, l[t.method])) &&
                    Q.forEach(
                      [
                        'delete',
                        'get',
            ...
            },
            {
              ...
              value: function (e) {
                return fe(
                  Fe((e = We(this.defaults, e)).baseURL, e.url),
                  e.params,
                  e.paramsSerializer,
                )
              },
      ...
      Xe = (function () {
        function e(t) {
          ...
          this.promise.then(function (e) {
            ...
            t(function (e, t, a) {
              r.reason || ((r.reason = new ze(e, t, a)), n(r.reason))
            })
        }
        return (
          J(
    ...
    var tt = (function e(t) {
      var n = new Ge(t),
        r = v(Ge.prototype.request, n)
      return (
        Q.extend(r, Ge.prototype, n, { allOwnKeys: !0 }),
    ...
    ;(tt.Axios = Ge),
      ...
      (tt.default = tt)
    var nt = tt,
      rt = { blogs: '/api/blogs', login: '/api/login' },
      at = function () {
        var e = JSON.parse(window.localStorage.getItem('loggedBlogAppUser'))
            ...
            return a().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (e.next = 2), nt.get(rt.blogs)
                  case 2:
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (
                      (n = at()),
                      (r = { headers: { Authorization: n } }),
                      (e.next = 4),
                      nt.post(rt.blogs, t, r)
                    )
                  case 4:
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (
                      (r = at()),
                      (o = { headers: { Authorization: r } }),
                      (e.next = 4),
                      nt.put(''.concat(rt.blogs, '/').concat(t), n, o)
                    )
                  case 4:
                ...
                switch ((e.prev = e.next)) {
                  case 0:
                    return (
                      ...
                      (r = { headers: { Authorization: n } }),
                      (e.next = 4),
                      nt.delete(''.concat(rt.blogs, '/').concat(t), r)
                    )
                  case 4:
                    return (o = e.sent), e.abrupt('return', o.data)
                  case 6:
          ...
          a().mark(function e(t) {
            ...
            return a().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (e.next = 2), nt.post(rt.login, t)
                  case 2:
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            t.preventDefault(), (e.prev = 1), (e.next = 4), n(o)
                          )
                        case 4:
                          i(ct), (e.next = 10)
                          break
    ...
    var dt = function (e) {
      ...
      ht = (0, e.forwardRef)(function (t, n) {
        var r = t.btnLabel,
          a = t.children,
        ...
        return (
          (0, e.useImperativeHandle)(n, function () {
            return { toggleVisibility: u }
          }),
          (0, p.jsxs)(p.Fragment, {
            children: [
              (0, p.jsx)('div', {
                style: s,
                children: (0, p.jsx)('button', { onClick: u, children: r }),
              }),
              (0, p.jsxs)('div', {
                style: c,
                children: [
                  a,
                  (0, p.jsx)('button', { onClick: u, children: 'cancel' }),
                ],
              }),
            ],
          })
    ...
    ht.displayName = 'Toggleable'
    var mt = ht,
      vt = function () {
        var t = d((0, e.useState)([]), 2),
          n = t[0],
          r = t[1],
          o = d((0, e.useState)({ username: '', password: '' }), 2),
          i = o[0],
          s = o[1],
          f = d((0, e.useState)(null), 2),
          h = f[0],
          v = f[1],
                ...
                return a().wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (e.prev = 0), (e.next = 3), lt(t)
                        case 3:
                          return (
                            (n = e.sent),
                            w.current.toggleVisibility(),
                            b({
                              type: 'notification',
                              text: 'Success, a new blog '
                                .concat(n.title, ' by ')
                                .concat(n.author, ' added.'),
                            }),
                            (e.next = 8),
                            S()
                          )
                        ...
                        case 10:
                          ;(e.prev = 10),
                            (e.t0 = e.catch(0)),
                            b({ type: 'error', text: 'there was error occur' })
                        case 13:
                        case 'end':
                          return e.stop()
                      }
        ...
        return (0, p.jsx)('div', {
          children: h
            ? (0, p.jsxs)(p.Fragment, {
                children: [
                  (0, p.jsx)('h2', { children: 'blogs' }),
                  (0, p.jsx)(dt, { notification: y, setNotification: b }),
                  (0, p.jsxs)('p', {
                    children: [
                      'User ',
                      h.username,
                      ' is logged in. You can',
                      ' ',
                      (0, p.jsx)('button', {
                        onClick: function () {
            ...
            : (0, p.jsxs)(p.Fragment, {
                children: [
                  (0, p.jsx)('h2', { children: ' Log in to application' }),
                  (0, p.jsx)('p', {
                    children:
                      'Example login credential: Anna01, password: test123',
                  }),
                  (0, p.jsx)(dt, { notification: y, setNotification: b }),
                  (0, p.jsx)(pt, {
    ...
    t.createRoot(document.getElementById('root')).render((0, p.jsx)(vt, {}))
  })()
})()
//# sourceMappingURL=main.e9593cab.js.map
